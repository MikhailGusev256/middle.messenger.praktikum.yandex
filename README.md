...
- Авторизация (кнопка авторизации сразу переводит на страницу чатов)
- Регистрация
- Список чатов и переписка (добавил немного мок данных)
- Настройки пользователя
- Ошибка 404 (сюда и в страницу 500 можно попасть только изменив первоначальную страницу в app.ts)
- Ошибка 500
...
Проект развёрнут на Netlify: https://6a25c80a9ef3e1a28578897f--dapper-snickerdoodle-50ee4d.netlify.app/